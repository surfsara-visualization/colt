 ...
 * 
 * It's main purpose is to represent timestamp as 64 bit byte array. First 4
 * bytes are integer seconds part, other 4 bytes are seconds fraction.
 * 
...
public class Timestamp {
     ...
     */
    private final double ntpTimestamp;
    ...
    /**
     * Construct NTP timestamp with unix timesamp in milliseconds. Encodes byte
     * array representation of timestamp.
     * 
     * @param timestamp
    ...
    /**
     * Construct NTP timestamp with unix timesamp in seconds. Encodes byte array
    ...
    /**
     * Construct NTP timestamp with 64 bit byte array. Decodes 64 bit byte array
     * timestamp to double value.
     * 
     * @param data
     *            64 bit byte array representing NTP timestamp
     */
