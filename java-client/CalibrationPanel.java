    ...
    extends JPanel
{
    ...
    public static final float   marker_positions[][] =
    {
        { 0.25f, 0.25f },
        { 0.75f, 0.25f },
        { 0.25f, 0.75f },
    ...
    // Set the touch position associated with the current marker (as input by the user)
    ...
    // That can be used to map touch coordinates to (normalized) screen coordinates:
